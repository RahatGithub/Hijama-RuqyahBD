...
class Assessment(BaseModel):
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='ruqyah_assessments_user')
    appointment = models.ForeignKey(Appointment, on_delete=models.CASCADE, related_name='ruqyah_assessments_appointment', null=True, blank=True)
