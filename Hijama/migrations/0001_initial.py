    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.IntegerField(choices=[(1, 'Male'), (0, 'Female')], verbose_name='লিঙ্গ/Gender')),
                ('address', models.TextField(verbose_name='ঠিকানা/Address')),
                ('diabetes', models.IntegerField(choices=[(1, 'High'), (0, 'Normal'), (-1, 'Low'), (-1, 'Unaware')], verbose_name='ডায়াবেটিস(খালিপেটে)/Diabetes(Empty stomach)')),
                ('blood_pressure', models.IntegerField(choices=[(1, 'High'), (0, 'Normal'), (-1, 'Low'), (-1, 'Unaware')], verbose_name='রক্তচাপ/Blood Pressure')),
                ...
                ('appointment', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='hijama_assessments_appointment', to='Main.appointment')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='hijama_assessments_user', to='Main.user')),
            ],
            options={
                'abstract': False,
            },
